...
int main(int argc, char **argv) {
    ...
    //filter
    app.add_flag("-5,--trim5End", cmd_info.trim_5end_, "do sliding window 5end trim, default is off");
    app.add_flag("-3,--trim3End", cmd_info.trim_3end_, "do sliding window 3end trim, default is off");
    app.add_option("--trimFront1", cmd_info.trim_front1_, "read1 trim front size, default is 0");
    app.add_option("--trimFront2", cmd_info.trim_front2_, "read2 trim front size, default is 0");
    app.add_option("--trimTail1", cmd_info.trim_tail1_, "read1 trim tail size, default is 0");
    app.add_option("--trimTail2", cmd_info.trim_tail2_, "read2 trim tail size, default is 0");


    app.add_flag("-g,--trimPolyg", cmd_info.trim_polyg_, "do polyg trim, default is off");
    app.add_flag("-x,--trimPolyx", cmd_info.trim_polyx_, "do polyx trim, default is off");


    app.add_flag("-u,--addUmi", cmd_info.add_umi_, "do umi add, default is off");
    app.add_option("--umiLen", cmd_info.umi_len_, "umi length, default is 0");
    string umiLoc = "";
    app.add_option("--umiLoc", umiLoc, "umi local, default is UMI_LOC_NONE");
    app.add_option("--umiPrefix", cmd_info.umi_prefix_, "umi prefix");
    app.add_option("--umiSkip", cmd_info.umi_skip_, "umi skip, default is 0");
    ...
    //TGS
    //TODO now just se
    app.add_flag("--TGS", cmd_info.is_TGS_, "process TGS data, default is off");
    ...
    //parallel gz
    app.add_flag("--usePugz", cmd_info.use_pugz_, "use pugz to decompress, default is off");
