...
#include "common_rapidgzip.hpp"  // duration
              ...
              const int line )
{
    ...
    if ( a != b ) {
        ++gnTestErrors;
        std::cout << "[FAIL on line " << line << "] " << a << " != " << b << "\n";
    }
}
         ...
         int                line )
{
    ...
    if ( !condition ) {
        ++gnTestErrors;
        std::cout << "[FAIL on line " << line << "] " << conditionString << "\n";
    }
}
                   ...
                   Functor      functor )
{
    ...
    try {
        ...
        std::cout << "Failed to run setup with exception: " << e.what() << "\n";
        return {};
    }
