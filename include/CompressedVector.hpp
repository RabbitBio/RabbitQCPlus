          ...
          const CompressionType                            compressionType )
{
    ...
    case CompressionType::GZIP:
        ...
        try {
            ...
            std::cout << "[Warning] Compression with ISA-L failed unexpectedly with: " << exception.what() << "\n";
            std::cout << "[Warning] Will use zlib as a fallback. Please report this bug anyway.\n";
